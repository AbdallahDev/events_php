...
//I'll check the categoryId, if it's 0 I'll get all the entities to be sent to the mobile app to be saved in the local db, else I'll get
//the entities that belong to a specific category.
if ($categoryId == 0) {
