...
if (isset($_POST['submit'])) {
    ...
    $table_live_design->table_live_design_insert($_POST['table_live_design_font_size'], $_POST['table_live_design_event_entity_column_width'], $_POST['table_live_design_event_time_column_width'], $_POST['table_live_design_event_place_column_width'], $_POST['table_live_design_event_subject_column_width'], $table_live_design_status);
