...
CREATE TABLE `committees` (
  ...
  `committee_rank` int(11) NOT NULL COMMENT 'this row to give committees rank as the one in the internal JHR rules of procedure',
...
INSERT INTO `committees` (`committee_id`, `committee_name`, `committee_rank`, `directorate_id`) VALUES
(2, '', 500, 2),
(3, '', 500, 3),
(4, '', 500, 4),
(9, 'لجنة العمل والتنمية الاجتماعية والسكان', 11, 2),
(10, 'اللجنة القانونية', 1, 2),
(11, 'لجنة الخدمات العامة والنقل', 13, 2),
(12, 'لجنة التربية والتعليم والثقافة', 6, 2),
(13, 'لجنة الشؤون الخارجية', 4, 2),
(14, 'لجنة النزاهة والشفافية وتقصي الحقائق', 19, 2),
(15, 'لجنة الصحة والبيئة', 9, 2),
(16, 'لجنة الشباب والرياضة', 7, 2),
(17, 'لجنة الاقتصاد والاستثمار', 3, 2),
(19, 'لجنة السياحة والاثار', 14, 2),
(20, 'لجنة الاخوة الاردنية السعودية', 300, 3),
(21, 'لجنة الاخورة الاردنية الجزائرية', 300, 3),
(22, 'لجنة الاخوة الاردنية القطرية', 300, 3),
(23, 'لجنة الاخوة البرلمانية الاردنية اللبنانية', 300, 3),
(24, 'كتلة الوفاء والعهد', 400, 4),
(28, 'كتلة التجديد', 400, 4),
(31, 'لجنة الطاقة والثروة المعدنية', 12, 2),
(38, 'اللجنة المالية', 2, 2),
(39, 'اللجنة الادارية', 5, 2),
(40, 'لجنة التوجيه الوطني والاعلام', 8, 2),
(41, 'لجنة الزراعة والمياه', 10, 2),
(42, 'لجنة الحريات العامة وحقوق الانسان', 15, 2),
(43, 'لجنة فلسطين', 16, 2),
(44, 'لجنة الريف والبادية', 17, 2),
(45, 'لجنة النظام والسلوك', 18, 2),
(46, 'لجنة المرأة وشؤون الأسرة', 20, 2),
(47, 'كتلة العدالة', 400, 2);
...
(786, 16, '', '11:51:00', '', 'اجتماع اللجنة', '2018-11-12', 0, '', '2018-11-12 11:51:44', 30566, '0000-00-00 00:00:00', -1, 2, 0),
(787, 17, '', '11:53:00', '', 'اجتماع لجنة الاقتصاد', '2018-11-13', 0, '', '2018-11-12 11:53:16', 30566, '0000-00-00 00:00:00', -1, 2, 0),
(788, 44, '', '11:53:00', '', '', '2018-11-11', 0, '', '2018-11-12 11:53:30', 30566, '0000-00-00 00:00:00', -1, 2, 0),
(789, 16, '', '11:56:00', '', '', '2018-11-12', 0, '', '2018-11-12 11:56:13', 30566, '0000-00-00 00:00:00', -1, 2, 0),
(790, 16, '', '12:01:00', '', '87', '2018-11-12', 0, '', '2018-11-12 12:02:02', 30566, '0000-00-00 00:00:00', -1, 2, 0),
(791, 16, '', '13:24:00', '', 'تجتمع اللجنة اليوم', '2018-11-12', 0, '', '2018-11-12 13:24:44', 30566, '0000-00-00 00:00:00', -1, 2, 0);
...
--
ALTER TABLE `device_token`
  MODIFY `device_token_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
